      ...
      <div className="max-w-6xl mx-auto">
        ...
        {sitesChecked && hasVerifiedSite === false && (
          <div className="mb-6 flex items-center gap-3 px-5 py-4 rounded-xl bg-amber-50 border border-amber-200 text-sm text-amber-800">
            ...
            <Link href="/business/dashboard/settings" className="shrink-0 px-3 py-1.5 rounded-lg bg-amber-200 hover:bg-amber-300 text-amber-900 font-medium text-xs transition-colors">
              Go to Settings
            </Link>
          </div>
        )}
                  ...
                  <div className="shrink-0">
                    {batchStatus === "no-site" && (
                      <p className="text-base text-amber-600 font-medium">
                        <Link href="/business/dashboard/settings?connect=1" className="text-amber-600 cursor-pointer hover:underline">
        ...
        {/* Ranking Progress Tracker */}
        {!loading && <RankingProgressTracker posts={posts} />}
