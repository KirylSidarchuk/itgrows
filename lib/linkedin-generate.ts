...
- Final line: whatever the argument has earned — a statement, an observation, an admission of uncertainty, or sometimes a question.
- STOP WHEN THE ARGUMENT IS FINISHED. Do not add a closing paragraph that points back at what you just said and restates it more abstractly — "This isn't just about X, it's about Y", "This highlights the need for", "This underscores", "What this means is". The strongest ending is usually the sentence before that one. If the last paragraph could be deleted without losing anything, it should not have been written.
- END DIFFERENTLY, PER POST: at most three or four of the set may close on a question. End the others on a flat statement, an observation, a consequence, or an admission that something is unresolved. A closing rhetorical question in every post is the single clearest sign of a template, whatever the posts are about.
...
- Length is set by the per-post rule above, not by a house range.
...
- STOP WHEN THE ARGUMENT IS FINISHED. Do not add a closing paragraph that points back at what you just said and restates it more abstractly — "This isn't just about X, it's about Y", "This highlights the need for", "This underscores", "What this means is". The strongest ending is usually the sentence before that one. If the last paragraph could be deleted without losing anything, it should not have been written.
- END DIFFERENTLY, PER POST: at most three or four of the set may close on a question. End the others on a flat statement, an observation, a consequence, or an admission that something is unresolved. A closing rhetorical question in every post is the single clearest sign of a template, whatever the posts are about.
- FIRST PERSON, PER POST, NOT ON AVERAGE: posts 1, 3, 5, 6, 8, 9, 11 and 13 must each carry a judgement in the author's own voice — "I have observed", "what I wish I had understood earlier", "I keep coming back to", "I am less sure of this than I was". Not a description of organisations from the outside. The rest may stand back. An author who never says "I" reads as a report.
- LENGTH, PER POST, NOT ON AVERAGE: make the 2nd and the 7th post short — under 100 words, one idea, stated and stopped. Make the 4th and the 10th long — over 190 words, working something through properly. Write the rest at whatever length the thought needs. Do not apply one length to the whole set; a batch of identically sized posts reads as a house style rather than a person.
