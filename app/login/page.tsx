...
function LoginForm() {
  ...
  const handleGoogleSignIn = () => {
    signIn("google", { callbackUrl: "/cabinet" })
  }
  ...
  return (
    <div className="bg-white border border-black/10 rounded-2xl p-8">
      <button
        ...
        className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl border border-black/10 bg-white hover:bg-gray-50 text-[#1b1916] text-sm font-medium transition-colors"
      >
